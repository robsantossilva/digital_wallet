...
use Robsantossilva\DigitalWallet\Domain\Entities\Wallet\UserWallet;
...
{
    public function testNewUserWallet()
    {
        $inputValues = [
        ...
        $this->assertEquals([Type::SHOPKEEPER], $userWallet->validTypesToTransfer());
    }
}
