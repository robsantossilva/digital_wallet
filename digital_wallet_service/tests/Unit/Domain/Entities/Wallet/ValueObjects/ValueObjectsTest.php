...
use Robsantossilva\DigitalWallet\Domain\Entities\Wallet\ValueObjects\Balance;
...
class ValueObjectsTest extends TestCase
{
    ...
    public function additionProvider(): array
    {
        return [
            ...
            [Balance::class, 0.0, true, ''],
            [Type::class, Type::SHOPKEEPER . 'ABC', false, 'Invalid Type'],
            [Type::class, Type::SHOPKEEPER, true, ''],
            [Type::class, Type::USER, true, '']
        ];
    }
